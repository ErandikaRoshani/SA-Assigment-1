...
import stockproducer.StockService;
import stockproducer.StockServiceImpl;
...
public class StockActivator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		...
		serviceReference = context.getServiceReference(StockService.class.getName());
		StockService servicePublish = (StockService) context.getService(serviceReference);
		...
		try {
			...
			while (true) {
				...
				if (username.equals("exit")) {
					System.out.println("Exiting from Stock Management Service !!!!");
					break;
				}
				System.out.print("Enter Password : ");
				password = scanner.next();
				System.out.println("\n=================Logged for Stock Management=====================\n");
	...
	public void stop(BundleContext context) throws Exception {
		System.out.println("Stock Consumer Service Stopped!");
